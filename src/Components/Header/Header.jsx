...
import { changeSearch } from './../../Redux/Slices/paramsSlice'
...
function Header() {
	...
	useEffect(() => {
		const handleClickListener = event => {
			if (
				!event.composedPath().includes(searchBtn.current) &&
				!event.composedPath().includes(searchDiv.current)
			) {
		...
		<div className='Header'>
			...
			<div className='Header-menu'>
				<div className='Header-menu-search'>
					{
						searchActive && (
						<div ref={searchDiv} className='Header-menu-search-input'>
							...
							<input autoFocus value={query} onChange={(event) => {
								...
								onChangeInput(event)
							}} id='header-search-menu-input' type='text' placeholder='Поиск пицц' />
							{ query &&
							<svg onClick={() => {
								setQuery('')
								dispatch(changeSearch(''))
								setSearchActive(false)
							}} id='header-search-menu-x' xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none">
								<rect fill="white"/>
					...
					}
					{
						search &&
						(
							<p id='text-search'>Текстовый запрос: <span>{search}</span></p>
						)
					}
					<button ref={searchBtn} onClick={() => {
				...
				<NavLink to='/cart'>
					<button className='Header-menu-button'>
						<p id='header-button-summ'>
							{itemsPrice}{' '}₽
						</p>
						<div id='header-button-delimiter'></div>
						<div id='header-button-cart'>
							...
							<path d="M4.78002 4.99999H16.3334L15.2134 10.5933C15.1524 10.9003 14.9854 11.176 14.7417 11.3722C14.4979 11.5684 14.1929 11.6727 13.88 11.6667H6.83335C6.50781 11.6694 6.1925 11.553 5.94689 11.3393C5.70128 11.1256 5.54233 10.8295 5.50002 10.5067L4.48669 2.82666C4.44466 2.50615 4.28764 2.21182 4.04482 1.99844C3.80201 1.78505 3.48994 1.66715 3.16669 1.66666H1.66669" stroke="white" strokeWidth="2.2" strokeLinecap="round" strokeLinejoin="round"></path>
							</svg>
							<p>{itemsCount}</p>
						</div>
					</button>
